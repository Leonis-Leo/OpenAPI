...
.menu { height: calc(100% - 154px); overflow: hidden auto; border-right: 0; background: transparent; }.menu-label { padding: 12px 24px 7px; color: #64748b; font-size: 11px; letter-spacing: .08em; }.menu :deep(.el-menu-item) { height: 44px; margin: 3px 12px; border-radius: 9px; color: #94a3b8; }.menu :deep(.el-menu-item .el-icon) { margin-right: 12px; font-size: 17px; }.menu :deep(.el-menu-item:hover) { background: rgba(148,163,184,.1); color: #f8fafc; }.menu :deep(.el-menu-item.is-active) { background: #dbeafe; color: #1d4ed8; font-weight: 600; }.menu :deep(.el-menu--collapse .el-menu-item) { justify-content: center; margin-right: 8px; margin-left: 8px; }.menu :deep(.el-menu--collapse .el-icon) { margin-right: 0; }
